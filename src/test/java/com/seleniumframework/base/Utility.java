...
public class Utility extends BaseClass{
        ...
        public static void invokeApplicationURL(String browserName, String url) {
            ...
            driver = BaseClass.selectDriver(browserName);
         ...
         */
        public java.util.List<WebElement> waitListOfAllElementsVisible(java.util.List<WebElement> elements) {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
         ...
         * @Description :To wait until the list of elements are  visible and return list of elements
         */
        public java.util.List<WebElement> waitListOfAllElementsVisible(By locator) {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
        ...
        public boolean isListOFElementsDisplayedOnScreen(By locator) {
            ...
            try {
                sleep(3);
                java.util.List<WebElement> weList = driver.findElements(locator);
                if (weList.size() > 0) {
                    blnDisplay = true;
                }
            } catch (Exception e) {
         ...
         */
        public java.util.List<WebElement> getElementList(By locator) {
...
//                return flag;
        ...
        public boolean validateDropDownOptions(By locator, String sOptions) {
            ...
            if (driver != null) {
                ...
                if (sLstArray.length > 1) {
                    java.util.List<WebElement> lstOptions = sLstEle.getOptions();
        ...
        public boolean validateRadioSingle(By locator) {
            ...
            if (driver != null) {
                waitForLoading();
                java.util.List<WebElement> RadioGroup1 = driver.findElements(locator);
        ...
        public String getListElementText(By locator) {
            java.util.List<WebElement> ele = driver.findElements(locator);
         ...
         * @return string
         */
        public String getListElementText(java.util.List<WebElement> ele) {
            StringBuilder textList = new StringBuilder();
...
//    }
        ...
        public void clickFromListOfElements (java.util.List<WebElement> elements, String text) {
